                ...
                <div>
                    <div className="flex items-center justify-between py-3 md:py-5 md:block">
                        <a href="javascript:void(0)">
                            <h1 className="text-2xl font-bold hospital-logo">AFYA HOSPITAL</h1>
                        </a>
                ...
                <div
                    ...
                    >
                        <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                            ...
                            <li className="text-gray-600 hover:text-blue-600">
                              <NavLink className="hover:border-b-4 pb-2 border-white" to="/doctors">
                                Doctors
                              </NavLink>
                            </li>
                            <li className="text-gray-600 hover:text-blue-600">
                              <NavLink className="hover:border-b-4 pb-2 border-white" to="/newappointment">
                                New Appointments
                              </NavLink>
                            </li>
                            <li className="text-gray-600 hover:text-blue-600">
                            ...
                            <li className="text-gray-600 hover:text-blue-600">
                              <NavLink className="hover:border-b-4 pb-2 border-white" to="/aboutus">
                                About Us
                              </NavLink>
                            </li>
